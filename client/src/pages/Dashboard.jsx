        ...
        <>
            <div className='flex h-screen'>
                ...
                <div className="flex-1 p-6 bg-gray-100">
                    ...
                    <section className='h-2/5  bg-gray-800 rounded-md'>
                        <h3 className='p-3 text-xl text-white'>Notificaciones</h3>

                    </section>
                    <div className='flex h-2/5'>
                        <section className='w-2/4 my-4 mx-2 bg-gray-800 rounded-md'>
                        ...
                        <section className='w-2/4 my-4 mx-2 bg-gray-800 rounded-md'>
                            ...
                            {filterEmployees.map((employee) => (
                                <div key={employee._id} className='px-2 flex text-white'>
                                    <h4 className='basis-1/2'>{employee.name}</h4>
                                    <h4 className='basis-1/2'>{employee.position}</h4>
                                </div>
                            ))}
                        </section>
                    </div>
